...
import static com.nio.redis.framework.client.protocol.CommandKeyword.AFTER;
import static com.nio.redis.framework.client.protocol.CommandKeyword.AND;
import static com.nio.redis.framework.client.protocol.CommandKeyword.BEFORE;
import static com.nio.redis.framework.client.protocol.CommandKeyword.ENCODING;
import static com.nio.redis.framework.client.protocol.CommandKeyword.FLUSH;
import static com.nio.redis.framework.client.protocol.CommandKeyword.GETNAME;
import static com.nio.redis.framework.client.protocol.CommandKeyword.IDLETIME;
import static com.nio.redis.framework.client.protocol.CommandKeyword.KILL;
import static com.nio.redis.framework.client.protocol.CommandKeyword.LEN;
import static com.nio.redis.framework.client.protocol.CommandKeyword.LIMIT;
import static com.nio.redis.framework.client.protocol.CommandKeyword.LIST;
import static com.nio.redis.framework.client.protocol.CommandKeyword.LOAD;
import static com.nio.redis.framework.client.protocol.CommandKeyword.NO;
import static com.nio.redis.framework.client.protocol.CommandKeyword.NOSAVE;
import static com.nio.redis.framework.client.protocol.CommandKeyword.NOT;
import static com.nio.redis.framework.client.protocol.CommandKeyword.ONE;
import static com.nio.redis.framework.client.protocol.CommandKeyword.OR;
import static com.nio.redis.framework.client.protocol.CommandKeyword.REFCOUNT;
import static com.nio.redis.framework.client.protocol.CommandKeyword.RESET;
import static com.nio.redis.framework.client.protocol.CommandKeyword.RESETSTAT;
import static com.nio.redis.framework.client.protocol.CommandKeyword.SETNAME;
import static com.nio.redis.framework.client.protocol.CommandKeyword.WITHSCORES;
import static com.nio.redis.framework.client.protocol.CommandKeyword.XOR;
import static com.nio.redis.framework.client.protocol.CommandType.*;
...
import com.nio.redis.framework.client.codec.BaseCoder;
import com.nio.redis.framework.client.codec.RedisCodec;
import com.nio.redis.framework.client.exception.RedisCommandInterruptedException;
import com.nio.redis.framework.client.exception.RedisException;
import com.nio.redis.framework.client.output.BooleanListOutput;
import com.nio.redis.framework.client.output.BooleanOutput;
import com.nio.redis.framework.client.output.ByteArrayOutput;
import com.nio.redis.framework.client.output.DateOutput;
import com.nio.redis.framework.client.output.DoubleOutput;
import com.nio.redis.framework.client.output.IntegerOutput;
import com.nio.redis.framework.client.output.KeyListOutput;
import com.nio.redis.framework.client.output.KeyOutput;
import com.nio.redis.framework.client.output.KeyValueOutput;
import com.nio.redis.framework.client.output.MapOutput;
import com.nio.redis.framework.client.output.MultiOutput;
import com.nio.redis.framework.client.output.NestedMultiOutput;
import com.nio.redis.framework.client.output.ScoredValueListOutput;
import com.nio.redis.framework.client.output.ScriptOutputType;
import com.nio.redis.framework.client.output.StatusOutput;
import com.nio.redis.framework.client.output.StringListOutput;
import com.nio.redis.framework.client.output.ValueListOutput;
import com.nio.redis.framework.client.output.ValueOutput;
import com.nio.redis.framework.client.output.ValueSetOutput;
...
import com.nio.redis.framework.client.protocol.CommandType;
...
import com.nio.redis.framework.client.protocol.SortArgs;
import com.nio.redis.framework.client.protocol.ZStoreArgs;

/**
 * An asynchronous thread-safe connection to a redis server. Multiple threads may
 * share one {@link RedisAsync} provided they avoid blocking and transactional
 ...
 *
 */
public class RedisAsync<K, V> extends SimpleChannelUpstreamHandler {
     ...
     */
    public RedisAsync(BlockingQueue<Command<K, V, ?>> queue, RedisCodec<K, V> codec, long timeout, TimeUnit unit) {
        this.queue = queue;
        this.codec = codec;
    ...
    public Future<RedisKeyValue<K, V>> blpop(long timeout, K... keys) {
    ...
    public Future<RedisKeyValue<K, V>> brpop(long timeout, K... keys) {
        CommandArgs<K, V> args = new CommandArgs<K, V>(codec).addKeys(keys).add(timeout);
    ...
    public String digest(V script) {
        try {
            ...
            return new String(BaseCoder.encode(md.digest(), false));
